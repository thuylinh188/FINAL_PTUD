...
## Location
$location = "http://localhost:8088/FINAL/admin/uploads/news" . uniqid() . $filename;
...
$sql_str = "INSERT INTO `news` (`title`, `avatar`, `slug`, `summary`, `description`, `newscategory_id`, `created_at`, `updated_at`) VALUES 
    ('$name', 
    '$location',
    '$slug', 
    '$sumary',
